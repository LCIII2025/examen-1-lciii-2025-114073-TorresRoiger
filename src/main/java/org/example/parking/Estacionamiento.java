...
public class Estacionamiento {
    ...
    private final Map<String, Ticket> vehiculosEstacionados = new HashMap<>(); //Key = patente
    private final Map<String, Cliente> clientesRegistrados = new HashMap<>(); //Key = dni
    ...
    public boolean ingresarVehiculo(String dni, String nombre, Vehiculo vehiculo) {
        ...
        if (!(vehiculosEstacionados.get(vehiculo.getPatente()) == null)) {
            return false;
        }
